  ...
  .container-content {
    ...
    .banner {
      ...
      &.banner-top {
        ...
        .title {
          height: 53vh;
          background: url("../assets/home/first-screen_02.png") no-repeat top
            center;
        ...
        .banner-content {
          ...
          .top {
            .left {
              ...
              .top_bg {
                background: url("../assets/home/case-bg.png") no-repeat center
                  center;
                width: 4.19rem;
                height: 3.84rem;
            ...
            .right {
              margin-left: -0.3rem;
              display: inline-block;
              background: url("../assets/home/case-iphone.png") no-repeat center
                center;
              width: 2.49rem;
              height: 4.74rem;
